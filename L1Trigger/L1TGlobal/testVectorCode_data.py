...
process.dumpGT = cms.EDAnalyzer("l1t::GtInputDump",
		...
		etsumInputTag    = cms.InputTag("gtInput"),
                CICADAInputTag   = cms.InputTag("gtInput", "CICADAScore"),
...
process.simGtStage2Digis.CICADAInputTag = cms.InputTag("gtStage2Digis", "CICADAScore")
...
process.gtStage2Raw.CICADAInputTag = cms.InputTag("gtInput", "CICADAScore")
...
process.l1tGlobalAnalyzer = cms.EDAnalyzer('L1TGlobalAnalyzer',
                                           ...
                                           cicadaToken    = cms.InputTag("gtStage2Digis", "CICADAScore"),
